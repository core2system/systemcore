...
<div class="container-xxl flex-grow-1 container-p-y">
       ...
       <form method="POST"   action="{{route('client.update')}}">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label>Address</label>
              <input  type="text" class="form-control" name="company_address" value="{{$prof->address}}">
            </div>
            <div class="form-group">
              <label>Email</label>
            ...
            <div class="form-group" style="display:none;">
              <label>Contact</label>
              <input  type="number" class="form-control" name="client_id" value="">
            </div>
  ...
  <div class="modal" tabindex="-1" role="dialog" id="login_modal">
    <div class="modal-dialog" role="document">
     <form method="POST"   action="{{url('profilestoreImage')}}" enctype="multipart/form-data">
      @csrf
      @method('POST')
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input  type="text" class="form-control" name="applicant_id" value="{{$prof->applicant_code}}"style="display:none;">
